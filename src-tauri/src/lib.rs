...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            hermes_bridge::notion_prototype_provider_proxy_info,
            hermes_bridge::notion_prototype_run_mcp_smoke,
            ...
            connectors::commands::notion_prototype_select_roots,
            connectors::commands::notion_prototype_search,
