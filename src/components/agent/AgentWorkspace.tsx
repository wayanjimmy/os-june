...
// handle never ships.
const AGENT_STREAM_DEMO_EVENT = "june:agent:stream-demo";
const STREAM_DEMO_SECTION_LABEL = "Streaming replay";
type AgentStreamDemoDetail = { show: boolean; charsPerSecond: number };
let streamDemoDesired: AgentStreamDemoDetail = { show: false, charsPerSecond: 80 };

function setStreamDemoDesired(show: boolean, charsPerSecond: number) {
